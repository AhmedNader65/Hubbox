package com.hubbox.ui.home.notifications
...
import com.hubbox.R
import com.hubbox.adapters.NotificationsAdapter
import com.hubbox.model.Spot
import com.hubbox.utils.OrderStatus
import kotlinx.android.synthetic.main.fragment_notifications.*


class NotificationsFragment : Fragment(), NotificationsAdapter.OnNotificationInteract {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        notificationsList.adapter = NotificationsAdapter(createSpots(), this)
    }
    ...
    override fun onTrackOrder() {
        Navigation.findNavController(notificationsList).navigate(R.id.trackOrderFragment)
    }
}